  ...
  return (
    <main className="relative min-h-screen">
      ...
      <div className="pointer-events-none absolute top-30 left-14 right-20 z-20 flex items-start justify-between">
        ...
        {/* FIXED: replaced <img> with <Image> and added proper props */}
        <div className="pointer-events-auto">
          <Image
            src="/iitrpr_logo.png"
            alt="IIT Ropar Logo"
            width={400}
            height={400}
            className="h-44 w-auto drop-shadow-[0_0_12px_rgba(0,0,0,0.8)]"
            priority
          />
        </div>
      ...
      <div className="relative z-10">
        ...
        <section className="pt-28 md:pt-36 pb-10 px-6 max-w-6xl mx-auto text-center">
          ...
          >
            <div className="mt-25 mb-10 gradient-text text-3xl md:text-8xl font-extrabold tracking-tight">
              Prefest
            </div>
            ...
            <p className="mt-10 mb-15 text-3xl text-cyan-50 drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
              Asia&apos;s largest Science & Technology festival meets North
              India&apos;s premier technical fest. A first look at what’s coming
              — energy, innovation, and creativity.
            </p>
        ...
        <motion.section
          id="details"
          className="py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center"
          initial={{ opacity: 0, y: 24 }}
        ...
        >
          <motion.h2
            className="gradient-text mt-65 mb-15 text-4xl md:text-5xl font-bold mb-6"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                details: [
                  "Round 1: Online prep course",
                  "Round 2: Zonal onsite contest",
                  "Finale: IIT Bombay",
                ],
              },
              {
                ...
                venue: "M3–M4",
                details: [
                  "Eligibility: Classes 8–10",
                  "Time-bound objective quiz",
                  "Direct finals entry at IITB",
                ],
              },
              {
              ...
              <motion.div
                ...
                className="group relative overflow-hidden rounded-xl backdrop-blur-lg bg-black/60 border p-0 hover:bg-black/70 transition-all duration-300 hover:shadow-[0_0_60px_rgba(168,85,247,0.5)] hover:scale-105 border-purple-400/40"
              >
                <div className="p-6 flex flex-col items-center text-center gap-3">
                  <div
                    className={`p-3 rounded-full bg-gradient-to-r ${card.color} shadow-[0_0_20px_rgba(168,85,247,0.6)]`}
                  />
                  <h3 className="text-cyan-100 font-bold text-xl drop-shadow-[0_0_10px_rgba(34,211,238,0.8)]">
                    {card.title}
                  </h3>
                  <p className="text-cyan-50 drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)]">
                    {card.desc}
                  </p>
        ...
        <section className="mt-30 mb-15 py-10 px-6 max-w-6xl mx-auto text-center">
          <motion.h2
            className="gradient-text text-3xl md:text-5xl font-bold"
          ...
          <motion.p
            className="mt-10 text-white/85 max-w-5xl text-2xl"
            initial={{ opacity: 0, y: 12 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.1 }}
          >
            Experience the unprecedented fusion of Techfest, IIT Bombay –
            Asia&apos;s largest Science & Technology festival meets North
            India&apos;s premier technical fest.
          </motion.p>
        </section>
        ...
        <section className="py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-6">
            <motion.div
              className="relative overflow-hidden rounded-xl backdrop-blur-lg bg-black/60 border border-cyan-400/40 p-6 hover:bg-black/70 transition-all duration-300 hover:shadow-[0_0_60px_rgba(34,211,238,0.5)] hover:scale-105"
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
            >
              <div className="text-lg font-semibold mb-2 text-cyan-100">
                Advitiya&apos;s Rising Star
              </div>
              <ul className="space-y-2 text-cyan-50 list-disc pl-5">
                <li>15,000+ student footfall from 200+ regional colleges.</li>
                <li>
                  North India&apos;s largest technical festival hosted at IIT
                  Ropar.
                </li>
              </ul>
            </motion.div>
            ...
            <motion.div
              className="relative overflow-hidden rounded-xl backdrop-blur-lg bg-black/60 border border-purple-400/40 p-6 hover:bg-black/70 transition-all duration-300 hover:shadow-[0_0_60px_rgba(168,85,247,0.5)] hover:scale-105"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6, delay: 0.08 }}
            >
              <div className="text-lg font-semibold mb-2 text-purple-100">
                Techfest Legacy Meets Northern Innovation
              </div>
              <ul className="space-y-2 text-cyan-50 list-disc pl-5">
                <li>
                  28-year journey as Asia&apos;s largest science and technology
                  festival.
                </li>
                <li>
                  180,000+ annual footfall, global recognition, and world
                  records.
                </li>
              </ul>
            </motion.div>
