    ...
    <main className="relative min-h-screen">
      ...
      <section className="pt-28 md:pt-36 pb-10 px-6 max-w-6xl mx-auto text-center">
        <motion.div className="text-center" initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <div className="mt-25 mb-10 gradient-text text-3xl md:text-6xl font-extrabold tracking-tight">Prefest</div>
          <motion.a href="#details" className="gradient-button" whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
          ...
          <p className="mt-10 mb-15 text-2xl text-cyan-50 drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">Asia's largest Science & Technology festival meets North India's premier technical fest. A first look at what’s coming — energy, innovation, and creativity.</p>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-6 mb-4">
            <div className="flex items-center space-x-3 text-cyan-200 bg-black/60 backdrop-blur-md px-5 py-3 rounded-full border border-cyan-400/50 shadow-[0_0_20px_rgba(34,211,238,0.3)]">
              <Calendar size={20} className="drop-shadow-[0_0_8px_rgba(34,211,238,1)]" />
      ...
      <motion.section id="details" className="py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center" initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.5 }}>
        <motion.h2 className="gradient-text mt-65 mb-15 text-4xl md:text-5xl font-bold mb-6" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.5 }}>Featured Events</motion.h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          {[{
            ...
            <motion.div key={card.title} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.45, delay: i*0.06 }} className="group relative overflow-hidden rounded-xl backdrop-blur-lg bg-black/60 border p-0 hover:bg-black/70 transition-all duration-300 hover:shadow-[0_0_40px_rgba(168,85,247,0.4)] border-purple-400/40">
      ...
      <section className="py-10 px-6 max-w-6xl mx-auto text-center">
        <motion.h2 className="gradient-text text-2xl md:text-3xl font-bold" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.5 }}>The Ultimate Tech Extravaganza</motion.h2>
        <motion.p className="mt-4 text-white/85 max-w-4xl" initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }}>
      ...
      <section className="py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-6">
          <motion.div className="relative overflow-hidden rounded-xl backdrop-blur-lg bg-black/60 border border-cyan-400/40 p-6 hover:bg-black/70 transition-all duration-300 hover:shadow-[0_0_40px_rgba(34,211,238,0.4)]" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
          ...
          <motion.div className="relative overflow-hidden rounded-xl backdrop-blur-lg bg-black/60 border border-purple-400/40 p-6 hover:bg-black/70 transition-all duration-300 hover:shadow-[0_0_40px_rgba(168,85,247,0.4)]" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.05 }}>
